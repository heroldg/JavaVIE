...
public class TestTranstypage {
    ...
    // En Java, pour tester si le transtypage descendant est possible, il faut utiliser l'opérateur instanceOf. L'oérateur de cast() permet pour sa part de réaliser le transtypage descendant. 
